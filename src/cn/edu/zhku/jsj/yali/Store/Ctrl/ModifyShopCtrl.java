...
import cn.edu.zhku.jsj.yali.Store.Service.ModifyShopService;


//店铺后台修改商品信息
public class ModifyShopCtrl extends HttpServlet {

	ModifyShopService mss=new  ModifyShopService();
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			result=mss.insertshopinfo(good);
		} catch (Exception e) {
